...
pub struct LegacyGridModeHandler {
    is_mode_active: bool,
    points: Vec<Point>,
    region: Region,
}

impl Default for LegacyGridModeHandler {
    fn default() -> Self {
        let points = generate_points();
        LegacyGridModeHandler { is_mode_active: false, points, region: Region::default() }
    }
}
...
impl Bind for LegacyGridModeHandler {
...
impl Draw for LegacyGridModeHandler {
...
impl Handler for LegacyGridModeHandler {
